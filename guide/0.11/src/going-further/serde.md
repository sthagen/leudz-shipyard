...
Serializing [`EntityId`](https://docs.rs/shipyard/0.11/shipyard/struct.EntityId.html) is technically all that is needed to serialize all entities and components in a [`World`](https://docs.rs/shipyard/0.11/shipyard/struct.World.html).\
...
[`EntityId`](https://docs.rs/shipyard/0.11/shipyard/struct.EntityId.html) is very easy to (de)serialize.
Example:
...
When deserializing, components will be attributed to the same [`EntityId`](https://docs.rs/shipyard/0.11/shipyard/struct.EntityId.html) they were serialized with. They will override any existing component.
