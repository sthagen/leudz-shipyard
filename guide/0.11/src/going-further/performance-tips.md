...
Prefer moving the loop inside [`run`](https://docs.rs/shipyard/0.11/shipyard/struct.World.html#method.run) and move [`borrow`](https://docs.rs/shipyard/0.11/shipyard/struct.World.html#method.borrow)'s call outside the loop.

### `bulk_add_entity`

When creating many entities at the same time remember to call [`bulk_add_entity`](https://docs.rs/shipyard/0.11/shipyard/struct.World.html#method.bulk_add_entity) if possible.
